...
urlpatterns = [
    ...
    path('lab_worker/test/', views.create_test, name='create_test'),
    path('lab_worker/dashboard/', views.lab_worker_dashboard, name='lab_worker_dashboard'),
    path('lab_worker/create_report/', views.create_patient_report, name='create_patient_report'),
    path('lab_worker/manage_tests/', views.manage_tests, name='manage_tests'),
    path('lab_worker/test_requests/', views.lab_test_requests, name='lab_test_requests'),
    path('lab_worker/accept_request/<int:request_id>/', views.accept_test_request, name='accept_test_request'),
    path('lab_worker/complete_report/<int:request_id>/', views.complete_test_report, name='complete_test_report'),
    ...
    path('pharmacist/search_medicines/', views.search_medicines, name='search_medicines'),
    
    path('lab_worker/signup/', views.register_labworker, name='register_labworker'),
    path('pharmacist/signup/', views.register_pharmacist, name='register_pharmacist'),
    
    
    path('lab_worker/login/', views.login_labworker, name='lab_worker_login'),
    path('pharmacist/login/', views.login_pharmacist, name='pharmacist_login'),
    path('send_test_details/', docviews.send_test_details, name='send_test_details'),
    path('send_test_results/', views.send_test_results, name='send_test_results'),
    path('patientappointment/', userviews.create_appointment, name='patientappointment'),
    path('payment-success/', userviews.payment_success, name='payment_success'),
    path('payment-failed/', userviews.payment_failed, name='payment_failed'),
    ...
    path('prescription_detail/<int:prescription_id>/', views.prescription_detail, name='prescription_detail'),
